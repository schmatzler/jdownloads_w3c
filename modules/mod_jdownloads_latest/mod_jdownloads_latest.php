...
require_once __DIR__ . '/helper.php';
    ...
    $text_before           = ModJDownloadsLatestHelper::getOnlyLanguageSubstring($before);
    $after                 = trim($params->get( 'text_after' ) );
    $text_after            = ModJDownloadsLatestHelper::getOnlyLanguageSubstring($after);
    ...
    $cat_show_text         = ModJDownloadsLatestHelper::getOnlyLanguageSubstring($cat_show_text);
